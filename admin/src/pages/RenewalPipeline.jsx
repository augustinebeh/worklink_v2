    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Loading renewal pipeline...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage contract renewals and business development opportunities</p>
        </div>
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white p-6 rounded-lg border">
            <div className="flex items-center">
              <div className="flex-1">
                ...
                <p className="text-2xl font-bold text-gray-900">{stats.summary.total_renewals || 0}</p>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg border">
            <div className="flex items-center">
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-600">Next 6 Months</p>
                <p className="text-2xl font-bold text-orange-900">{stats.summary.next_6_months || 0}</p>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg border">
            <div className="flex items-center">
              <div className="flex-1">
                ...
                <p className="text-2xl font-bold text-green-900">{stats.summary.high_probability || 0}</p>
              </div>
                ...
                {filteredRenewals.map((renewal) => (
                  <tr key={renewal.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div>
                        <div className="text-sm font-medium text-gray-900">{renewal.agency}</div>
