/**
 * Renewal Modal Body Component
 * Renders the tabbed content (overview + activities) for a renewal detail modal
 */
...
import { getProbabilityColor } from './RenewalModalHeader';
...
export default function RenewalModalBody({
  renewal,
  activeTab,
  setActiveTab,
  isEditing,
